...
// Noel Franceschi
// MDF 3Term 1610
// FileReadAndWrite.java

@SuppressWarnings("FieldCanBeLocal")
public class FileReadAndWrite extends ActionBarActivity implements View.OnClickListener {
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (myMarker != null) {
                            ...
                            fileStorage.deleteMarkerFromFile(myMarker);

                            Intent myIntent = new Intent(FileReadAndWrite.this, MainActivity.class);
    ...
    private void editMarker() {
        ...
        Intent myIntent = new Intent(FileReadAndWrite.this, FormActivity.class);
